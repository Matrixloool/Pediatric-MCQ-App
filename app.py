...
# ----------------------------------------------------
# Root-cause fix for Google Sheets PEM Private Key padding issue
# ----------------------------------------------------
try:
    if "connections" in st.secrets and "gsheets" in st.secrets["connections"]:
        # st.secrets is read-only, but st.secrets._secrets is the underlying dict!
...
if "api_key" not in st.session_state:
    # Try to auto-load key from secrets or env for zero-config mobile launch
    try:
